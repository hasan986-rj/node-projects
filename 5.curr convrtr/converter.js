...
function currenceyconverter(amount, from, to) {
...
async function startConverter() {
    ...
    await inquirer.prompt([
        ...
        if (convertedAmount !== undefined) {
            ...
            console.log('Invalid currency codes. Please enter valid currency codes.');
    });
    inquirer.prompt({
        type: 'confirm',
        name: 'continue',
        ...
        if (answers1.continue) {
            ...
            console.log('Thankyou for using currency converter. Good bye.');
    });
}
;
